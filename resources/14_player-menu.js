...
$('#ok-duplicate').click(function () {
    ...
    $('#duplicate-popup').hide();
    if (window.top.location.pathname && (window.top.location.pathname).toLowerCase().indexOf("/mypresentations") != -1) {
...
function openPrivateUpgradePopup() {
    if (!(window.self === window.top) && parent.document.URL.toLowerCase().indexOf("mypresentations") != -1) {
        ...
        $('#upgrade-popup-btn').html("<img src=\"/RESOURCES/mypres/css/images/btn_upgrade_normal.png\" alt=\"\" onmouseover=\"this.src='../../css/images/btn_upgrade_hover.png'\" onmouseout=\"this.src='../../css/images/btn_upgrade_normal.png'\" onclick=\"openPricingPage('2', 'private-btn');\" />");
        openUpgradePopup();
    }
}
...
function openPasswordUpgradePopup() {
    if (!(window.self === window.top) && parent.document.URL.toLowerCase().indexOf("mypresentations") != -1) {
        ...
        $('#upgrade-popup-btn').html("<img src=\"/RESOURCES/mypres/css/images/btn_tell_normal.png\" alt=\"\" onmouseover=\"this.src='../../css/images/btn_tell_hover.png'\" onmouseout=\"this.src='../../css/images/btn_tell_normal.png'\" onclick=\"openPricingPage('3', 'password-btn');\" />");
        openUpgradePopup();
    }
}
...
function openCollaborateUpgradePopup() {
    if (!(window.self === window.top) && parent.document.URL.toLowerCase().indexOf("mypresentations") != -1) {
        ...
        $('#upgrade-popup-btn').html("<img src=\"/RESOURCES/mypres/css/images/btn_tell_normal.png\" alt=\"\" onmouseover=\"this.src='../../css/images/btn_tell_hover.png'\" onmouseout=\"this.src='../../css/images/btn_tell_normal.png'\" onclick=\"openPricingPage('6', 'collaborate-btn');\" />");
        openUpgradePopup();
    }
}
...
function openDownloadUpgradePopup() {
    if (!(window.self === window.top) && parent.document.URL.toLowerCase().indexOf("mypresentations") != -1) {
        ...
        $('#upgrade-popup-btn').html("<img src=\"/RESOURCES/mypres/css/images/btn_tell_normal.png\" alt=\"\" onmouseover=\"this.src='../../css/images/btn_tell_hover.png'\" onmouseout=\"this.src='../../css/images/btn_tell_normal.png'\" onclick=\"openPricingPage('4', 'download-btn');\" />");
        openUpgradePopup();
    }
}
...
var printPopup = (function () {
    ...
    function init() {
        ...
        //$('#print-pdf-btn').on('click', function () {
        //    window.open($(this).data("href") + "?preference=" + ($('.print-option-clicked').data('preference') + $(this).data('adjustment')) + "&pdf=true");
        //});

        //$('#ok-print').on('click', function () {
        //    window.open($(this).data("href") + "?preference=" + ($('.print-option-clicked').data('preference') + $(this).data('adjustment')) + "&pdf=false");
        //});
